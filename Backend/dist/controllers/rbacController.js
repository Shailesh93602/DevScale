...
const rbacValidators_1 = require("../validators/rbacValidators");
class RBACController {
    static async createRole(req, res, next) {
        try {
            (0, validateRequest_1.validateRequest)(rbacValidators_1.roleSchema, req.body);
    ...
    static async createPermission(req, res, next) {
        try {
            (0, validateRequest_1.validateRequest)(rbacValidators_1.permissionSchema, req.body);
    ...
    static async assignRoleToUser(req, res, next) {
        try {
            (0, validateRequest_1.validateRequest)(rbacValidators_1.roleAssignmentSchema, req.body);
