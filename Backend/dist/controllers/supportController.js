...
const supportValidators_1 = require("../validators/supportValidators");
const createTicket = async (req, res, next) => {
    try {
        (0, validateRequest_1.validateRequest)(supportValidators_1.ticketSchema, req.body);
...
const createBugReport = async (req, res, next) => {
    try {
        (0, validateRequest_1.validateRequest)(supportValidators_1.bugReportSchema, req.body);
...
const createFeatureRequest = async (req, res, next) => {
    try {
        (0, validateRequest_1.validateRequest)(supportValidators_1.featureRequestSchema, req.body);
...
const createHelpArticle = async (req, res, next) => {
    try {
        (0, validateRequest_1.validateRequest)(supportValidators_1.helpArticleSchema, req.body);
