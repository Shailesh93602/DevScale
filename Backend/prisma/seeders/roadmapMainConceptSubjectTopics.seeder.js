...
const roadmap_1 = require("../../resources/roadmaps/roadmap");
...
const seedDatabase = async () => {
    try {
        ...
        for (const category of roadmap_1.roadmapCategories) {
        ...
        const categoriesWithRoadmaps = new Set();
        ...
        const seedRoadmapData = async (roadmapData, categoryName) => {
        ...
        for (const roadmapData of roadmap_1.roadmaps) {
            let matchedCategory = roadmap_1.roadmapCategories.find((c) => roadmapData.tags.includes(c)) || roadmap_1.roadmapCategories[0];
...
seedDatabase();
//# sourceMappingURL=roadmapMainConceptSubjectTopics.seeder.js.map