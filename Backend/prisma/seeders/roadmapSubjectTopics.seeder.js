                ...
                for (const [mcIndex, mainConceptData,] of roadmapData.mainConcepts.entries()) {
                    ...
                    for (const [sIndex, subjectData,] of mainConceptData.subjects.entries()) {
                        ...
                        for (const [tIndex, topicData] of subjectData.topics.entries()) {
                            ...
                            const existingSubjectTopic = await prismaTransaction.subjectTopic.findUnique({
                                where: {
                                    subject_id_topic_id: {
                                        subject_id: subject.id,
                                        topic_id: topic.id,
                            ...
                            const existingRoadmapTopic = await prismaTransaction.roadmapTopic.findUnique({
                                where: {
                                    roadmap_id_topic_id: {
                                        roadmap_id: roadmap.id,
                                        topic_id: topic.id,
...
seedDatabase();
//# sourceMappingURL=roadmapSubjectTopics.seeder.js.map