...
const USERS = {
  student: { email: 'testuser@yopmail.com', password: 'E2E_STUDENT_PASSWORD_REDACTED' },
  student2: { email: 'battleplayer2@yopmail.com', password: 'E2E_STUDENT2_PASSWORD_REDACTED' },
  admin: { email: 'admin@eduscale.io', password: 'E2E_ADMIN_PASSWORD_REDACTED' },
  moderator: { email: 'moderator@eduscale.io', password: 'E2E_MODERATOR_PASSWORD_REDACTED' },
};
