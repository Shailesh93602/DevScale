...
async function main() {
  const tok = await login("testuser@yopmail.com", "E2E_STUDENT_PASSWORD_REDACTED");
  const tok2 = await login("battleplayer2@yopmail.com", "E2E_STUDENT2_PASSWORD_REDACTED");
