...
import { createForumSchema, updateForumSchema } from '../validations/forumValidations';
...
export class CommunityForumRoutes extends BaseRouter {
  ...
  protected initializeRoutes(): void {
    ...
    this.router.post('/create', validateRequest(createForumSchema), this.communityForumController.createForum);
    this.router.put('/update/:id', validateRequest(updateForumSchema), this.communityForumController.updateForum);
