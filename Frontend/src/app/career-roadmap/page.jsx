  ...
  sections: [
        {
          ...
          "steps": [
            ...
            { title: "Understanding Client-Server Architecture", description: "Learn about client-server architecture." },
            { title: "Version Control with Git", description: "Learn Git for version control." }
          ]
        },
        {
          "title": "Fundamentals of Database",
          "steps": [
            { title: "Basics of Relational Databases", description: "Learn about relational databases." },
            { title: "SQL Basics", description: "Learn SQL basics." },
            { title: "MySQL Database", description: "Learn about MySQL." },
            { title: "Data Modeling and Design", description: "Learn data modeling and design." },
            { title: "Normalization", description: "Learn about normalization." },
            { title: "Database Transactions", description: "Learn about database transactions." }
          ]
        },
        {
