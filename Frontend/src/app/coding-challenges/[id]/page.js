...
const challenges =
  [
...

    {
      ...
      difficulty: "Hard",
      inputFormat: "A series of get and put operations with a specified capacity.",
      outputFormat: "Results of the operations based on LRU policy.",
      sampleInput: "LRUCache cache = new LRUCache(2); cache.put(1, 1); cache.put(2, 2); cache.get(1); cache.put(3, 3); cache.get(2);",
    ...
    },
    {
      ...
      outputFormat: "The index of the target value in the array, or -1 if not found.",
    ...
    },
    {
      ...
      difficulty: "Hard",
      inputFormat: "Two strings (beginWord and endWord) and an array of strings (wordList).",
      outputFormat: "An integer representing the shortest transformation sequence length.",
    ...
    },
    {
      ...
      description: "Given an array of integers containing n + 1 integers where each integer is in the range [1, n] inclusive, find the duplicate number.",
      difficulty: "Medium",
      inputFormat: "An array of integers.",
    ...
    },
    {
      ...
      difficulty: "Hard",
      inputFormat: "An array of non-negative integers representing heights of walls.",
    ...
    },
    {
      ...
      outputFormat: "An integer representing the number of distinct ways to climb the stairs.",
      sampleInput: "n = 3",
      sampleOutput: "3",
