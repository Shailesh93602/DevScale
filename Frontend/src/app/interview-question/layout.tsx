 ...
 * carry it — which is exactly why `/interview-question` had none and inherited the generic
...
export const metadata: Metadata = {
  ...
  description:
    'Practice interview questions across core engineering topics, with answers.',
};
