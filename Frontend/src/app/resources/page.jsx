...
const ResourcesPage = () => {
  ...
  return (
    <div className="w-full mx-auto p-6">
      <div className="bg-lightSecondary shadow-2xl rounded-lg p-6 min-h-screen">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative mb-8">
            <input
              ...
              className="w-full p-4 pl-12 pr-4 rounded-full border border-border bg-light focus:outline-none focus:ring-2 focus:ring-ring transition-all duration-300 ease-in-out"
            />
