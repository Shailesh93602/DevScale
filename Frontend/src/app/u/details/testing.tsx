...
const StepSix = ({ control }: { control: Control<FieldValues> }) => (
  <>
...
const StepSeven = ({ control }: { control: Control<FieldValues> }) => (
  <>
...
const StepEight = ({ control }: { control: Control<FieldValues> }) => (
  <>
...
const StepNine = ({ control }: { control: Control<FieldValues> }) => (
  <>
    <h2 className="text-2xl font-semibold">
