                ...
                <div className="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                            <div>
                                <label htmlFor="username" className="block mb-2 text-sm font-medium text-gray-900"> Username or Email</label>
                            ...
                            <p className="text-sm font-light text-gray-500">
                                Don't have account? <a href="/u/register" className="font-medium text-primary-600 hover:underline">Create one</a>
                            </p>
                        </form>
                    </div>
                </div>
