    ...
    return (
        <div className="card">
            ...
            <div className="card-info">
                <span>Challange your opponents</span>
                <p>Conquer Challenges and Rise as a Champion in our Battlezone.</p>
                <a href="#" onClick={handlesubmit} className="challengeButton">Challenge</a>
            </div>
        </div>
    );
};
