...
export const AnimatedBattleCard = ({
  title,
  description,
  imageSrc,
  className,
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background:
            'linear-gradient(45deg, #8300b8, #690091, #8300b826, #690091)',
      ...
      >
        ...
        {imageSrc && (
          <motion.div
            className={cn('mb-4 overflow-hidden rounded-lg', imageClassName)}
            style={{
              transformStyle: 'preserve-3d',
