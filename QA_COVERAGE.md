...
|---|---|---|---|
| STUDENT | `testuser@yopmail.com` (teststudent) | `E2E_STUDENT_PASSWORD_REDACTED` | Core learner journey |
| STUDENT #2 | `battleplayer2@yopmail.com` | `E2E_STUDENT2_PASSWORD_REDACTED` | 2nd participant for battles |
| ADMIN | `admin@eduscale.io` | `E2E_ADMIN_PASSWORD_REDACTED` | Full admin panel |
| MODERATOR | `moderator@eduscale.io` | `E2E_MODERATOR_PASSWORD_REDACTED` | Article/forum moderation (no UI yet — see Moderator Plan) |
