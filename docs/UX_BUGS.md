...
- Landing advertises "Community" / "Active Community", which is a **deferred/hidden** feature — verify those CTAs route to `/auth/register` (per [DEFERRED_FEATURES.md](DEFERRED_FEATURES.md)) and never to the hidden `/community`.
